    ...
    <?php
        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                $customer_exists = exist_customers($conn,$cname,$cmatric,$cphone,$cgmail);
                $customer_added = false;
        
                if(!$customer_exists)
                {
                    // Route is unique, proceed
                    $sql = "INSERT INTO `customers` (`customer_name`, `customer_matric`, `customer_phone`, `customer_gmail`, `customer_created`) VALUES ('$cname', '$cmatric', '$cphone', '$cgmail', current_timestamp());";
        ...
        <?php
            ...
            <section id="customer">
                <div id="head">
                    <h4>U-Bus Customer Status</h4>
                </div>
                <div id="customer-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Add Students Details <i class="fas fa-plus"></i></button>
                    </div>
                    <table class="table table-hover table-bordered">
                        ...
                        <?php
                            while($row = mysqli_fetch_assoc($resultSqlResult))
                            {
                                ...
                                $customer_matric = $row["customer_matric"];
                                $customer_phone = $row["customer_phone"]; 
                                $customer_gmail = $row["customer_gmail"];
                        ?>
                        <tr>
                            <td>
                                <?php
                            ...
                            <button class="button edit-button " data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" data-id="<?php 
                                                ...
                                                echo $customer_matric;?>" data-phone="
                                                <?php 
                                                echo $customer_phone;?>"
                                                data-gmail="<?php 
                                                echo $customer_gmail;?>"
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cmatric" class="form-label">Cutomer Matric</label>

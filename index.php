...
<head>
    ...
    <title>UNISEL BUS ONLINE BOOKING SYSTEM</title>
    <!-- google fonts -->
...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["pnr-search"]))
    {
        ...
        if($num)
        {
            ...
            $customer_matric = get_from_table($conn, "customers", "customer_id", $customer_id, "customer_matric");

            $customer_phone = get_from_table($conn, "customers", "customer_id", $customer_id, "customer_phone");

            $customer_gmail = get_from_table($conn, "customers", "customer_id", $customer_id, "customer_gmail");
            ...
            <hr>
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            <strong>Customer Matric : </strong>
                            <?php echo $customer_matric; ?>
                        </li>
                        <li>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">U-BUS</a>
            ...
            <div>
                <a href="#" class="login nav-item" data-bs-toggle="modal" data-bs-target="#loginModal"><i class="fas fa-sign-in-alt" style="margin-right: 0.4rem;"></i>Login Admin</a>
                <a href="#" class="login nav-item" data-bs-toggle="modal" data-bs-target="#loginModalStudent"><i class="fas fa-sign-in-alt" style="margin-right: 0.4rem;"></i>Login Student</a>
    ...
    <?php 
        ...
        require 'assets/partials/_loginModalStudent.php';
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>UNISEL Bus Online Booking System</h1>

            <p class="text-center">Welcome to the UNISEL Bus Online Booking System (U-Bus). Make your booking now !! Get your seat for Unisel Bus (UNISEL-MRT SG-BULOH).</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                <h1>About Us</h1>
                <h4>Why this website exist?</h4>
                <p>
                    This UNISEL Bus Online Booking System was created to replace the traditional method of purchasing bus tickets. The system has a user-friendly interface that makes the booking process simple and efficient. The system also includes features such as route and seat selection, payment processing, and e-ticketing. This system is developed using programming languages such as HTML, CSS, PHP, and MySQL to ensure a smooth and interactive user experience. 
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class=""></i> <?php echo date('Y');?> - U-BUS | &#10084;&#65039; Muhamad Firdaus Bin Rosli
                        </p>
        </footer>
    </div>

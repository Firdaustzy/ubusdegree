                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Customer Matric:</b></em></h4></td>
                           
                            <td class="col-md-6 text-center"><?php echo $customer_matric; ?></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Customer Gmail:</b></em></h4></td>
                           
                            <td class="col-md-6 text-center"><?php echo $customer_gmail; ?></td>

...
<?php
        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                $customer_matric = $_POST["cmatric"];
                $customer_phone = $_POST["cphone"];
                $customer_gmail = $_POST["cgmail"];
            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                {
                    ...
                    `customer_name` = '$cname',
                    `customer_matric` = '$cmatic',
                    `customer_phone` = '$cphone'
                    `customer_gmail` = '$cgmail', WHERE `customers`.`customer_id` = '$customer_id';";
        ...
        <?php
            ...
            <section id="booking">
                <div id="head">
                    <h4>U-Bus Booking Information</h4>
                </div>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <button class="button btn-sm edit-button" data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" data-customerid="<?php 
                                                ...
                                                echo $customer_name;?>" data-matric="<?php 
                                                echo $customer_matric;?>"data-phone="<?php 
                                                echo $customer_phone;?>"data-gmail="<?php 
                                                echo $customer_gmail;?>" >Edit</button>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cmatric" class="form-label">Customer Matric</label>
                                <input type="text" class="form-control" id="cmatric" name="cmatric">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">Customer Gmail</label>
                                <input type="text" class="form-control" id="cgmail" name="cgmail">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row g-3">
                                <div class="col-auto">
                                    <img src="tng.jpg" alt="TNG PAYMENT" class="img-fluid" style="border: 1px solid #ccc; padding: 10px;">
                                </div>
                            </div>

                            <div class="row g-3">
                                <div class="col-auto">
                                    <img src="maybank.jpg" alt="Maybank PAYMENT" class="img-fluid" style="border: 1px solid #ccc; padding: 10px;">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="pdfFile" class="form-label">Payment Reciept</label>

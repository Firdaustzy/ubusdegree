            ...
            <section id="dashboard">
                ...
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="./bookingstudent.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="./busstudent.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        ...
                        <a href="./routestudent.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Seat" class="info-box status-item">
                        ...
                        <a href="./seatstudent.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <!-- <h3>User</h3> -->
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        ...
                        <a href="./customerstudent.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                ...
                <footer>
                    <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - U-Bus | &#10084;&#65039; Muhamad Firdaus Bin Rosli
                        </p>
                </footer>
        </div>
    </main>
